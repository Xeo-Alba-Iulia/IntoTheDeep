...
public class FConstants {
    static {
        ...
        FollowerConstants.translationalPIDFCoefficients.setCoefficients(0.35,0,0.016,0);
        ...
        FollowerConstants.drivePIDFCoefficients.setCoefficients(0.008,0,0.0023,0.5,0);
